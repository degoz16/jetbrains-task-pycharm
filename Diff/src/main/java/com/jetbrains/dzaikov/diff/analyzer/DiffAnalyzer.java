...
public class DiffAnalyzer {
  ...
  /**
   * <p>Get files difference in the convenient for HtmlDiffWriter format.</p>
   *
   * <p>{first file string number} {second file string number} {type of difference}
   * (if == -1, string added)   (if == -1, string removed)</p>
   *
   * @param filePath1 Path to the first file
   * @param filePath2 Path to the first file
   ...
   */
  public List<DiffStringsNumbersPair> getFilesDiff(
      String filePath1, String filePath2) throws IOException {
